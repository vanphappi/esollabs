import { CommunicationLayerPreference, DappMetadata, ServiceStatus, StorageManagerProps } from '@metamask/sdk-communication-layer';
...
export declare class MetaMaskSDK extends EventEmitter2 {
    ...
    private connectWithExtensionProvider;
    resume(): void;
    disconnect(): void;
    isAuthorized(): void;
    terminate(): void;
